...
procedure Check_Release_Package is
   --  Phase 19 release-package hygiene guard.
   --  manual_git_upload_pack_probe.adb is a manual/public-network example and
   --  must stay outside the default deterministic release verification path.
